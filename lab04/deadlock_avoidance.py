...
def train_model_a():
    ...
    print(
        "[Model A] Got GPU 1! Training complete."
    )
...
def train_model_b():
    ...
    But to prevent Circular Wait,
    we FORCE it to request GPU 0 first.
    """
    ...
    print(
        "[Model B] Got GPU 1! Training complete."
    )
